...
//
const BotName = 'IKHSAN77 BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ikhsan77.id'; // Nama Instagramlu cok
const whatsapplu = '082116794290'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'cooming soon cok'; // OFFICIAL GRUP LU 1
const grupch2 = 'cooming soon cok'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
